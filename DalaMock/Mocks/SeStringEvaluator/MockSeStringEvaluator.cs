namespace DalaMock.Core.Mocks.SeStringEvaluator;
...
public class MockSeStringEvaluator : ISeStringEvaluator, IMockService
{
        ...
        uint eRowIdValue)
    {
            ...
            && this.dataManager.GetExcelSheet<AddonSheet>(context.Language).TryGetRow(9, out var hqSymbol))
        {
            sb.Append(hqSymbol.Text);
                 ...
                 && this.dataManager.GetExcelSheet<AddonSheet>(context.Language)
        ...
        uint eColParamValue)
    {
        switch (resolvedSheetName)
        {
            ...
            case "Status" when this.dataManager.GetExcelSheet<StatusSheet>(context.Language)
